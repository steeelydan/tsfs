...
export const setup = (
    ...
    if (process.env.NODE_ENV === 'development') {
        if (manifestFilePath) {
            ...
            console.log(
                `Views engine setup in development mode without manifest file.\nViews path: ${viewsInBuildDirPath}`
            );
        }
    } else {
        if (manifestFilePath) {
            console.log(
                `Views engine setup in production mode with manifest file.\nViews path: ${viewsInBuildDirPath}\n Manifest file path: ${manifestFilePath}`
            );
        } else {
            console.log(
                `Views engine setup in production mode without manifest file.\nViews path: ${viewsInBuildDirPath}`
            );
        }
    }
