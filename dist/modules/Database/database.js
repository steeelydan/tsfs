...
export const create = async (dbConfig) => {
    ...
    if (config.dialect === 'sqlite') {
        ...
        console.log(`Database initialized, env: ${process.env.NODE_ENV}, dialect: ${config.dialect}, host: ${config.host}, port: ${config.port}, username: ${config.username}, database: ${config.database}`);
    }
    return sequelize;
};
